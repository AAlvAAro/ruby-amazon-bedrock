...
require_relative 'payload_builders/ai21_labs/j2_mid_v1'
require_relative 'payload_builders/ai21_labs/j2_ultra_v1'
...
require_relative 'payload_builders/stability/stable_diffusion_xl_v0'
require_relative 'payload_builders/stability/stable_diffusion_xl_v1'
...
module RubyAmazonBedrock
  ...
  class PayloadFactory
    ...
    def models_to_builders
      {
        'i21labs.j2-mid-v1' => PayloadBuilders::Ai21Labs::J2MidV1,
        ...
        'stability.stable-diffusion-xl-v0' => PayloadBuilders::Stability::StableDiffusionXlV0,
        'stability.stable-diffusion-xl-v1' => PayloadBuilders::Stability::StableDiffusionXlV1
      }
    end
  end
end
